...
public record BugView(
        ...
        /* 关联修复 Dev Task；尚未关联时为空。 */ Long devTaskId,
        /* 关联修复任务的公司内展示编号；尚未关联时为空。 */ String devTaskKey,
        /* 修复任务负责人标识；未指派时为空。 */ Long assigneeUserId,
        /* 修复任务负责人展示名称；未指派时为空。 */ String assigneeName,
