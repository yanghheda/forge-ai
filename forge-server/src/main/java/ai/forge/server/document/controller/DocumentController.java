...
public class DocumentController {
    ...
    public ResponseEntity<Document> create(@Valid @RequestBody CreateRequest body, HttpServletRequest request) {
        ...
        Document document = service.create(
            context.userId(), body.workspaceId(), body.projectId(), body.workItemId(), body.type(), body.title());
    ...
    public List<Document> list(
        @RequestParam long workspaceId, @RequestParam long projectId, @RequestParam long workItemId,
        HttpServletRequest request) {
        return service.listByWorkItem(
