...
const capabilities = [
  {
    icon: <IconRobot />,
    title: "AI 协作，而非黑盒自动化",
    text: "从上下文、执行计划到审批记录，每一步都清晰可追溯。",
  },
  {
    icon: <IconBranch />,
    title: "以需求贯穿交付链路",
    text: "每条 Requirement 直接连接产品、UX、开发、QA 与 Release。",
  },
  {
    icon: <IconCheckCircle />,
    title: "策略内建，交付可信",
    text: "权限、Guard 与高风险审批随流程运行，而不是事后补救。",
  },
];
