  ...
  return <div className={styles.page}>
    ...
    <main>
      <section className={styles.hero}>
        ...
        <div className={styles.eyebrow}><i /> AI-NATIVE SOFTWARE DELIVERY</div>
        ...
        <div className={styles.preview} aria-label="ForgeAI 产品预览">
          ...
          <div className={styles.previewBody}><aside><strong>F</strong><i /><i /><i /></aside><div className={styles.previewContent}>
            ...
            <div className={styles.flow}><span>Product <b>8</b></span><i /><span>UX <b>4</b></span><i /><span>Development <b>6</b></span><i /><span>QA <b>3</b></span></div>
          </div></div>
        </div>
      </section>
    ...
    <footer className={styles.footer}>ForgeAI <span>·</span> Software delivery, forged with intelligence.</footer>
  </div>;
}
