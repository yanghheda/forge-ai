...
import { Alert, Button, Card, Select, Spin, Tag, Typography } from "@arco-design/web-react";
...
export function OrganizationRequirementDetail({ requirementId }: { requirementId: number }) {
  ...
  const save = useMutation({
    ...
    onSuccess: () => void queryClient.invalidateQueries({ queryKey: ["requirements", requirementId, "participants"] }),
  });
